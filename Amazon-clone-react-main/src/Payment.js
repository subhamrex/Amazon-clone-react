        ...
        <div className="payment">
            <div className="payment_container">
             <h1>Checkout (<Link to='/checkout'>{basket?.length} items</Link>)
                ...
                <script src="https://www.paypal.com/sdk/js?client-id=AZqNldmfPWDXnVc23iKHc4rG7H8XxtZzpEikQr1AR7yJgSPGBxS1eAHm6wZ3Ojzod55o57u5AH9ok7Xj&currency=USD"></script>
